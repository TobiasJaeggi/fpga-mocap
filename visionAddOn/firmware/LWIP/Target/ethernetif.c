...
#define INTERFACE_INPUT_THREAD_STACK_SIZE ( 1024 )
...
uint8_t* persisted_mac = NULL; // MAC address loaded from eeprom will be stored here
/* USER CODE END 2 */
...
/* USER CODE END OS_THREAD_ATTR_CMSIS_RTOS_V2 */
  ...
  if(persisted_mac != NULL){
    log_info("[ethernetif] using MAC fetched from storage: %02x.%02x.%02x.%02x.%02x.%02", persisted_mac[0], persisted_mac[1], persisted_mac[2], persisted_mac[3], persisted_mac[4], persisted_mac[5]);
    heth.Init.MACAddr = &persisted_mac[0];
  }
...
/* USER CODE BEGIN OS_THREAD_NEW_CMSIS_RTOS_V2 */
  ...
  attributes.stack_size = INTERFACE_INPUT_THREAD_STACK_SIZE;
